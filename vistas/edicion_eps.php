                ...
                <div class="col-12 col-md-6 col-lg-8 col-xl-9 px-0 px-md-1">
                    <div class="box-formulario container mt-1 ml-1">
                        ...
                        <form name="formulario" class="formularioEditActDesact mt-3" id="formulario" method="POST">
                            ...
                            <!-- Teléfono -->
                            <div class="form-group row">
                                <label for="telefono" class="col-12 col-lg-4">Teléfono:</label>
                                <div class="col-12 col-lg-8">
                            ...
                            <!-- email -->
                            <div class="form-group row">
                                <label for="email" class="col-12 col-lg-4">email:</label>
                                <div class="col-12 col-lg-8">
                            ...
                            <!-- Dirección -->
                            <div class="form-group row">
                                <label for="direccion" class="col-12 col-lg-4">Dirección:</label>
                                <div class="col-12 col-lg-8">
